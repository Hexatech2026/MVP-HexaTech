...
function sortearNovoApelido() {
  ...
  void avatar.offsetWidth; // força reinício da animação
...
function carregarProximaPergunta() {
  ...
  // Cada uma das 5 alternativas ocupa uma zona do gol. A ordem já vem
  // embaralhada de gerarAlternativas, então só distribuímos nas zonas fixas.
